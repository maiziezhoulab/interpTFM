...
from uniprotkb_concept_constants import is_aa_level_concept
...
def calc_metrics_sparse(
    ...
    for threshold_idx in range(n_thresholds):
        ...
        for concept_idx in range(n_concepts):
            ...
            tp_sparse = sae_feats_binarized.multiply(concept_labels > 0) # 25065*233 . 25065*1 = 25065*233

            # 2 transformation
            # 1: apply scgpt subset/screen to geneXconcept mat 
            # 2: apply gene express or not mask to geneXconcept mat
            ...
            # Calculate domain-specific metrics for non-AA-level concepts / those "false entries" associated concepts
...
if __name__ == "__main__":
    ...
    analyze_all_shards_in_set(
        sae_dir=Path('/maiziezhou_lab2/yunfei/Projects/FM_temp/InterPLM/models/walkthrough_model'),
        esm_embds_dir=Path('/maiziezhou_lab2/yunfei/Projects/FM_temp/InterPLM/interplm/uniprotkb/embeddings'),
        eval_set_dir=Path('/maiziezhou_lab2/yunfei/Projects/FM_temp/InterPLM/interplm/uniprotkb/annotations/test'),
        output_dir=Path('/maiziezhou_lab2/yunfei/Projects/FM_temp/InterPLM/results/test_counts')
    )
